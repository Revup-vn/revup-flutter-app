...
import 'package:dartz/dartz.dart' as _i49;
import 'package:flutter/material.dart' as _i42;
import 'package:google_maps_flutter/google_maps_flutter.dart' as _i50;
...
import 'package:revup/h22_invoice/models/service_data.dart' as _i45;
...
import 'package:revup/h26_review-repairman/view/review_repairman_page.u.dart'
    as _i6;
import 'package:revup/h2_find_provider/models/provider_data.u.dart' as _i44;
...
import 'package:revup/notification_page/view/notification_page.u.dart' as _i39;
...
class AppRouter extends _i41.RootStackRouter {
  ...
  final Map<String, _i41.PageFactory> pagesMap = {
    ...
    NewServiceRequestRoute.name: (routeData) {
      ...
      return _i41.AdaptivePage<_i43.OptionalService?>(
          routeData: routeData,
    ...
    HomeBodyRoute.name: (routeData) {
      ...
      return _i41.AdaptivePage<void>(
          routeData: routeData,
          child: _i37.HomeBodyPage(key: args.key, user: args.user));
    },
    HistoryProviderRoute.name: (routeData) {
      final args = routeData.argsAs<HistoryProviderRouteArgs>();
      return _i41.AdaptivePage<void>(
          routeData: routeData,
          child: _i38.HistoryProviderPage(args.cid, key: args.key),
          maintainState: false);
    },
    NotificationRoute.name: (routeData) {
      return _i41.AdaptivePage<void>(
          routeData: routeData, child: const _i39.NotificationPage());
    },
    AccountRoute.name: (routeData) {
      return _i41.AdaptivePage<void>(
          routeData: routeData, child: const _i40.AccountPage());
    }
  };

  @override
  List<_i41.RouteConfig> get routes => [
        _i41.RouteConfig(SplashRoute.name, path: '/'),
        _i41.RouteConfig(OrderDetailRoute.name, path: '/order-detail-page'),
        _i41.RouteConfig(RepairStatusRoute.name, path: '/repair-status-page'),
        _i41.RouteConfig(ServiceInvoiceRoute.name,
            path: '/service-invoice-page'),
        _i41.RouteConfig(InvoicePaymentRoute.name,
            path: '/invoice-payment-page'),
        _i41.RouteConfig(ReviewRepairmanRoute.name,
        ...
        _i41.RouteConfig(HomeRoute.name, path: '/home-page', children: [
          ...
          _i41.RouteConfig(HistoryProviderRoute.name,
              path: 'history-provider-page', parent: HomeRoute.name),
          _i41.RouteConfig(NotificationRoute.name,
              path: 'notification-page', parent: HomeRoute.name),
          _i41.RouteConfig(AccountRoute.name,
              path: 'account-page', parent: HomeRoute.name)
        ]),
        _i41.RouteConfig(HistoryDetailRoute.name, path: '/history-detail-page'),
        ...
        _i41.RouteConfig(OTPRoute.name, path: '/o-tp-page'),
        _i41.RouteConfig(SignupRoute.name, path: '/signup-page'),
        _i41.RouteConfig(ChooseServiceRoute.name, path: '/choose-service-page'),
        _i41.RouteConfig(NewServiceRequestRoute.name,
            path: '/new-service-request-page'),
        _i41.RouteConfig(ServiceDetailRoute.name, path: '/service-detail-page'),
        _i41.RouteConfig(ChooseProductRoute.name, path: '/choose-product-page'),
        _i41.RouteConfig(FindNearbyRoute.name, path: '/find-nearby-page'),
        _i41.RouteConfig(RequestProviderRoute.name,
            path: '/request-provider-page'),
        _i41.RouteConfig(RepairerProfileRoute.name,
            path: '/repairer-profile-page'),
        _i41.RouteConfig(AddMessageRoute.name, path: '/add-message-page'),
        _i41.RouteConfig(OverViewOrderRoute.name,
            path: '/over-view-order-page'),
        _i41.RouteConfig(FAQsRoute.name, path: '/f-aqs-page'),
        _i41.RouteConfig(FAQsItemOTPRoute.name, path: '/f-aqs-item-ot-pPage'),
        _i41.RouteConfig(AboutUsRoute.name, path: '/about-us-page'),
        _i41.RouteConfig(TermsPrivacyRoute.name, path: '/terms-privacy-page'),
        _i41.RouteConfig(LoginEnterPhoneRoute.name,
            path: '/login-enter-phone-page'),
        _i41.RouteConfig(PermissionRoute.name, path: '/permission-page'),
        _i41.RouteConfig(MapRouteRoute.name, path: '/map-route-page'),
        _i41.RouteConfig(AddReportRoute.name, path: '/add-report-page'),
        _i41.RouteConfig(FindProviderRoute.name, path: '/find-provider-page')
      ];
}
...
class ServiceInvoiceRoute extends _i41.PageRouteInfo<ServiceInvoiceRouteArgs> {
  ServiceInvoiceRoute(
      {required String providerID, required String id, _i42.Key? key})
...
class InvoicePaymentRoute extends _i41.PageRouteInfo<InvoicePaymentRouteArgs> {
  InvoicePaymentRoute(
      {required _i44.ProviderData providerData,
      required List<_i45.ServiceData> serviceData,
      _i42.Key? key})
...
class InvoicePaymentRouteArgs {
  ...
  final _i44.ProviderData providerData;

  final List<_i45.ServiceData> serviceData;
...
class ReviewRepairmanRoute
    extends _i41.PageRouteInfo<ReviewRepairmanRouteArgs> {
  ReviewRepairmanRoute(
      {required String providerId, required String repairId, _i42.Key? key})
...
/// generated route for
/// [_i8.ReportPage]
class ReportRoute extends _i41.PageRouteInfo<ReportRouteArgs> {
  ReportRoute({required String cid, _i42.Key? key})
...
/// generated route for
/// [_i9.TestPage]
class TestRoute extends _i41.PageRouteInfo<TestRouteArgs> {
  TestRoute({_i42.Key? key})
...
class UpdateProfileRoute extends _i41.PageRouteInfo<UpdateProfileRouteArgs> {
  UpdateProfileRoute({_i42.Key? key, required _i43.AppUser user})
...
class OTPRoute extends _i41.PageRouteInfo<OTPRouteArgs> {
  OTPRoute(
      ...
      required _i47.Completer<dynamic> completer,
      _i42.Key? key})
      : super(OTPRoute.name,
            path: '/o-tp-page',
            args: OTPRouteArgs(
...
class SignupRoute extends _i41.PageRouteInfo<SignupRouteArgs> {
  SignupRoute(
      {required _i47.Completer<_i43.AppUser> completer,
      required String phoneNumber,
...
class SignupRouteArgs {
  ...
  final _i47.Completer<_i43.AppUser> completer;
...
class ChooseServiceRoute extends _i41.PageRouteInfo<ChooseServiceRouteArgs> {
  ChooseServiceRoute(
      {_i42.Key? key,
      required String providerId,
      required bool isSelectProduct,
      String? recordId,
      required List<_i43.OptionalService> optionalService})
...
class ChooseServiceRouteArgs {
  ...
  final List<_i43.OptionalService> optionalService;
...
class NewServiceRequestRoute
    extends _i41.PageRouteInfo<NewServiceRequestRouteArgs> {
...
class ServiceDetailRoute extends _i41.PageRouteInfo<ServiceDetailRouteArgs> {
  ServiceDetailRoute(
      {_i42.Key? key,
      required String providerId,
      required _i48.ServiceData serviceData,
      required _i49.Tuple2<_i43.RepairCategory, _i49.IList<_i48.ServiceData>>
          catAndSv})
...
class ServiceDetailRouteArgs {
  ...
  final _i48.ServiceData serviceData;

  final _i49.Tuple2<_i43.RepairCategory, _i49.IList<_i48.ServiceData>> catAndSv;
...
class ChooseProductRoute extends _i41.PageRouteInfo<ChooseProductRouteArgs> {
  ChooseProductRoute(
      {_i42.Key? key,
      required _i48.ServiceData serviceData,
      required _i49.Tuple2<_i43.RepairCategory, _i49.IList<_i48.ServiceData>>
...
/// generated route for
/// [_i23.FindNearbyPage]
class FindNearbyRoute extends _i41.PageRouteInfo<FindNearbyRouteArgs> {
  FindNearbyRoute({_i42.Key? key, required _i50.LatLng currentLocation})
...
class FindNearbyRouteArgs {
  ...
  final _i50.LatLng currentLocation;
...
class RequestProviderRoute
    extends _i41.PageRouteInfo<RequestProviderRouteArgs> {
...
class RepairerProfileRoute
    extends _i41.PageRouteInfo<RepairerProfileRouteArgs> {
  RepairerProfileRoute({_i42.Key? key, required _i44.ProviderData providerData})
...
/// generated route for
/// [_i26.AddMessagePage]
class AddMessageRoute extends _i41.PageRouteInfo<AddMessageRouteArgs> {
  AddMessageRoute(
      {_i42.Key? key,
      required _i44.ProviderData providerData,
...
class OverViewOrderRoute extends _i41.PageRouteInfo<OverViewOrderRouteArgs> {
  OverViewOrderRoute(
      {_i42.Key? key, required String providerId, required String recordId})
...
class FAQsItemOTPRoute extends _i41.PageRouteInfo<void> {
...
class TermsPrivacyRoute extends _i41.PageRouteInfo<void> {
...
class LoginEnterPhoneRoute
    extends _i41.PageRouteInfo<LoginEnterPhoneRouteArgs> {
...
/// generated route for
/// [_i34.MapRoutePage]
class MapRouteRoute extends _i41.PageRouteInfo<MapRouteRouteArgs> {
  MapRouteRoute({_i42.Key? key, required String providerId})
...
/// generated route for
/// [_i35.AddReportPage]
class AddReportRoute extends _i41.PageRouteInfo<AddReportRouteArgs> {
  AddReportRoute({required String reportID, _i42.Key? key})
...
class FindProviderRoute extends _i41.PageRouteInfo<void> {
...
/// generated route for
/// [_i37.HomeBodyPage]
class HomeBodyRoute extends _i41.PageRouteInfo<HomeBodyRouteArgs> {
  HomeBodyRoute({_i42.Key? key, required _i43.AppUser user})
...
/// generated route for
/// [_i38.HistoryProviderPage]
class HistoryProviderRoute
    extends _i41.PageRouteInfo<HistoryProviderRouteArgs> {
  HistoryProviderRoute({required String cid, _i42.Key? key})

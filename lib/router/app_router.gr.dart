...
import 'package:revup_core/core.dart' as _i41;
...
import 'package:revup/order-sevice/view/order_detail_page.u.dart' as _i30;
...
import 'package:revup/service/models/service_data.dart' as _i37;
...
class AppRouter extends _i35.RootStackRouter {
  ...
  final Map<String, _i35.PageFactory> pagesMap = {
    ...
    NewServiceRequestRoute.name: (routeData) {
      return _i35.AdaptivePage<_i37.ServiceData>(
    ...
    OrderDetailRoute.name: (routeData) {
      ...
      return _i35.AdaptivePage<void>(
          routeData: routeData, child: _i30.OrderDetailPage(key: args.key));
    },
  ...
  List<_i35.RouteConfig> get routes => [
        ...
        _i35.RouteConfig(ServiceDetailsRoute.name,
        ...
        _i35.RouteConfig(OrderDetailRoute.name, path: '/')
      ];
}
...
class ServiceDetailRoute extends _i35.PageRouteInfo<ServiceDetailRouteArgs> {
  ServiceDetailRoute(
      {_i36.Key? key, required String serviceId, required String providerId})
...
class Signup6Route extends _i35.PageRouteInfo<Signup6RouteArgs> {
  Signup6Route(
      {required _i40.Completer<_i41.AppUser> completer,
      required String phoneNumber,
...
class Signup6RouteArgs {
  ...
  final _i40.Completer<_i41.AppUser> completer;
...
class ServiceDetailsRoute extends _i35.PageRouteInfo<ServiceDetailsRouteArgs> {
  ServiceDetailsRoute({_i36.Key? key, required _i37.ServiceData serviceData})
...
class ServiceDetailsRouteArgs {
  ...
  final _i37.ServiceData serviceData;
...
class FindNearbyRoute extends _i35.PageRouteInfo<FindNearbyRouteArgs> {
  FindNearbyRoute({_i36.Key? key, required _i43.LatLng currentLocation})
...
class FindNearbyRouteArgs {
  ...
  final _i43.LatLng currentLocation;
...
class RequestProviderRoute extends _i35.PageRouteInfo<void> {
...
class RepairerProfileRoute
  ...
  RepairerProfileRoute({required String providerID, _i36.Key? key})
...
class OrderDetailRoute extends _i35.PageRouteInfo<OrderDetailRouteArgs> {
  OrderDetailRoute({_i36.Key? key})
      : super(OrderDetailRoute.name,
            path: '/', args: OrderDetailRouteArgs(key: key));

...
import 'package:revup/guide-support/view/about_us_page.u.dart' as _i23;
import 'package:revup/guide-support/view/faqs_page.u.dart' as _i21;
import 'package:revup/guide-support/view/terms_privacy_page.u.dart' as _i24;
import 'package:revup/guide-support/widgets/faqs_item_otp.u.dart' as _i22;
import 'package:revup/home/view/home_page.u.dart' as _i7;
import 'package:revup/home/widgets/home_body_page.u.dart' as _i25;
...
import 'package:revup/notification_page/view/notification_page.u.dart' as _i27;
...
class AppRouter extends _i29.RootStackRouter {
  ...
  final Map<String, _i29.PageFactory> pagesMap = {
    ...
    NewServiceRequestRoute.name: (routeData) {
      return _i29.AdaptivePage<_i31.ServiceData>(
    ...
    FAQsItemOTPRoute.name: (routeData) {
      return _i29.AdaptivePage<void>(
          routeData: routeData, child: const _i22.FAQsItemOTPPage());
    },
    AboutUsRoute.name: (routeData) {
      return _i29.AdaptivePage<void>(
          routeData: routeData, child: const _i23.AboutUsPage());
    },
    TermsPrivacyRoute.name: (routeData) {
      return _i29.AdaptivePage<void>(
          routeData: routeData, child: const _i24.TermsPrivacyPage());
    },
    HomeBodyRoute.name: (routeData) {
      return _i29.AdaptivePage<void>(
          routeData: routeData, child: const _i25.HomeBodyPage());
    },
    ActivateRoute.name: (routeData) {
      return _i29.AdaptivePage<void>(
          routeData: routeData, child: const _i26.ActivatePage());
    },
    NotificationRoute.name: (routeData) {
      return _i29.AdaptivePage<void>(
          routeData: routeData, child: const _i27.NotificationPage());
    },
    AccountRoute.name: (routeData) {
      return _i29.AdaptivePage<void>(
          routeData: routeData, child: const _i28.AccountPage());
    }
  };
  ...
  List<_i29.RouteConfig> get routes => [
        ...
        _i29.RouteConfig(InvoicePaymentRoute.name,
            path: '/invoice-payment-page'),
        _i29.RouteConfig(ReviewRepairmanRoute.name,
            path: '/review-repairman-page'),
        _i29.RouteConfig(HomeRoute.name, path: '/home-page', children: [
          _i29.RouteConfig(HomeBodyRoute.name,
              path: 'home-body-page', parent: HomeRoute.name),
          _i29.RouteConfig(ActivateRoute.name,
              path: 'activate-page', parent: HomeRoute.name),
          _i29.RouteConfig(NotificationRoute.name,
              path: 'notification-page', parent: HomeRoute.name),
          _i29.RouteConfig(AccountRoute.name,
              path: 'account-page', parent: HomeRoute.name)
        ]),
        _i29.RouteConfig(PaymentRoute.name, path: '/payment-page'),
        _i29.RouteConfig(UpdateProfileRoute.name, path: '/update-profile-page'),
        _i29.RouteConfig(TestRoute.name, path: '/test-page'),
        _i29.RouteConfig(LoginRoute.name, path: '/login-page'),
        _i29.RouteConfig(OnboardingRoute.name, path: '/onboarding-page'),
        _i29.RouteConfig(OTPRoute.name, path: '/o-tp-page'),
        _i29.RouteConfig(Signup6Route.name, path: '/signup6-page'),
        _i29.RouteConfig(ChooseServiceRoute.name, path: '/choose-service-page'),
        _i29.RouteConfig(NewServiceRequestRoute.name,
            path: '/new-service-request-page'),
        _i29.RouteConfig(ServiceDetailsRoute.name,
            path: '/service-details-page'),
        _i29.RouteConfig(ChooseProductRoute.name, path: '/choose-product-page'),
...
class ServiceDetailRoute extends _i29.PageRouteInfo<void> {
...
class RepairStatusRoute extends _i29.PageRouteInfo<void> {
...
class ServiceInvoiceRoute extends _i29.PageRouteInfo<void> {
...
class InvoicePaymentRoute extends _i29.PageRouteInfo<void> {
...
class ReviewRepairmanRoute extends _i29.PageRouteInfo<void> {
...
class UpdateProfileRoute extends _i29.PageRouteInfo<UpdateProfileRouteArgs> {
  UpdateProfileRoute(
      {_i30.Key? key,
...
/// generated route for
/// [_i10.TestPage]
class TestRoute extends _i29.PageRouteInfo<void> {
...
class OTPRoute extends _i29.PageRouteInfo<OTPRouteArgs> {
  OTPRoute(
      ...
      required _i34.Completer<dynamic> completer,
      _i30.Key? key})
      : super(OTPRoute.name,
            path: '/o-tp-page',
            args: OTPRouteArgs(
...
class OTPRouteArgs {
  ...
  final _i34.Completer<dynamic> completer;
...
/// generated route for
/// [_i14.Signup6Page]
class Signup6Route extends _i29.PageRouteInfo<Signup6RouteArgs> {
  Signup6Route(
      {required _i34.Completer<_i32.AppUser> completer,
      required String phoneNumber,
...
class Signup6RouteArgs {
  ...
  final _i34.Completer<_i32.AppUser> completer;
...
class ChooseServiceRoute extends _i29.PageRouteInfo<void> {
...
class NewServiceRequestRoute extends _i29.PageRouteInfo<void> {
...
class ServiceDetailsRoute extends _i29.PageRouteInfo<ServiceDetailsRouteArgs> {
  ServiceDetailsRoute({_i30.Key? key, required _i31.ServiceData serviceData})
...
class ServiceDetailsRouteArgs {
  ...
  final _i31.ServiceData serviceData;
...
class ChooseProductRoute extends _i29.PageRouteInfo<void> {
...
class ListRepairerRoute extends _i29.PageRouteInfo<void> {
...
class RepairerProfileRoute
    extends _i29.PageRouteInfo<RepairerProfileRouteArgs> {
  RepairerProfileRoute({required String providerID, _i30.Key? key})
...
/// generated route for
/// [_i22.FAQsItemOTPPage]
class FAQsItemOTPRoute extends _i29.PageRouteInfo<void> {
...
/// generated route for
/// [_i24.TermsPrivacyPage]
class TermsPrivacyRoute extends _i29.PageRouteInfo<void> {
...
/// generated route for
/// [_i25.HomeBodyPage]
class HomeBodyRoute extends _i29.PageRouteInfo<void> {
...
/// generated route for
/// [_i26.ActivatePage]
class ActivateRoute extends _i29.PageRouteInfo<void> {

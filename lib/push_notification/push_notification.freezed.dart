...
class __$$_PushNotificationCopyWithImpl<$Res>
  ...
  __$$_PushNotificationCopyWithImpl(
      ...
      : super(_value, (v) => _then(v as _$_PushNotification));

  @override
  _$_PushNotification get _value => super._value as _$_PushNotification;
...
class _$_PushNotification implements _PushNotification {
  const _$_PushNotification({required this.title, required this.body});
...
abstract class _PushNotification implements PushNotification {
  const factory _PushNotification(
      ...
      required final String body}) = _$_PushNotification;

...
import 'package:revup_core/core.dart' as _i33;

import 'package:revup/account/model/user_model.dart' as _i34;
import 'package:revup/account/view/account_page.u.dart' as _i29;
import 'package:revup/activate/view/activate_page.u.dart' as _i27;
...
class AppRouter extends _i30.RootStackRouter {
  ...
  final Map<String, _i30.PageFactory> pagesMap = {
    ...
    NewServiceRequestRoute.name: (routeData) {
      return _i30.AdaptivePage<_i32.ServiceData>(
    ...
    ActivateRoute.name: (routeData) {
      return _i30.AdaptivePage<void>(
          routeData: routeData, child: const _i27.ActivatePage());
    },
  ...
  List<_i30.RouteConfig> get routes => [
        ...
        _i30.RouteConfig(InvoicePaymentRoute.name,
            path: '/invoice-payment-page'),
        _i30.RouteConfig(ReviewRepairmanRoute.name,
        ...
        _i30.RouteConfig(HomeRoute.name, path: '/home-page', children: [
          ...
          _i30.RouteConfig(ActivateRoute.name,
        ...
        _i30.RouteConfig(OTPRoute.name, path: '/o-tp-page'),
        _i30.RouteConfig(Signup6Route.name, path: '/signup6-page'),
        _i30.RouteConfig(ChooseServiceRoute.name, path: '/choose-service-page'),
        _i30.RouteConfig(NewServiceRequestRoute.name,
            path: '/new-service-request-page'),
        _i30.RouteConfig(ServiceDetailsRoute.name,
            path: '/service-details-page'),
        _i30.RouteConfig(ChooseProductRoute.name, path: '/choose-product-page'),
        _i30.RouteConfig(ListRepairerRoute.name, path: '/list-repairer-page'),
        _i30.RouteConfig(RepairerProfileRoute.name,
            path: '/repairer-profile-page'),
        _i30.RouteConfig(OverViewOrderRoute.name,
            path: '/over-view-order-page'),
        _i30.RouteConfig(FAQsRoute.name, path: '/f-aqs-page'),
        _i30.RouteConfig(FAQsItemOTPRoute.name, path: '/f-aqs-item-ot-pPage'),
        _i30.RouteConfig(AboutUsRoute.name, path: '/about-us-page'),
        _i30.RouteConfig(TermsPrivacyRoute.name, path: '/terms-privacy-page')
      ];
}
...
class ServiceDetailRoute extends _i30.PageRouteInfo<void> {
...
class RepairStatusRoute extends _i30.PageRouteInfo<void> {
...
class ServiceInvoiceRoute extends _i30.PageRouteInfo<void> {
...
class InvoicePaymentRoute extends _i30.PageRouteInfo<void> {
...
class ReviewRepairmanRoute extends _i30.PageRouteInfo<void> {
...
class UpdateProfileRoute extends _i30.PageRouteInfo<UpdateProfileRouteArgs> {
  UpdateProfileRoute(
      {_i31.Key? key,
      required _i34.UserModel user,
      required _i33.AppUser model})
...
class OTPRoute extends _i30.PageRouteInfo<OTPRouteArgs> {
  OTPRoute(
      ...
      required _i35.Completer<dynamic> completer,
      _i31.Key? key})
      : super(OTPRoute.name,
            path: '/o-tp-page',
            args: OTPRouteArgs(
...
class OTPRouteArgs {
  ...
  final _i35.Completer<dynamic> completer;
...
/// generated route for
/// [_i14.Signup6Page]
class Signup6Route extends _i30.PageRouteInfo<Signup6RouteArgs> {
  Signup6Route(
      {required _i35.Completer<_i33.AppUser> completer,
      required String phoneNumber,
...
class Signup6RouteArgs {
  ...
  final _i35.Completer<_i33.AppUser> completer;
...
class ChooseServiceRoute extends _i30.PageRouteInfo<void> {
...
class NewServiceRequestRoute extends _i30.PageRouteInfo<void> {
...
class ServiceDetailsRoute extends _i30.PageRouteInfo<ServiceDetailsRouteArgs> {
  ServiceDetailsRoute({_i31.Key? key, required _i32.ServiceData serviceData})
...
class ChooseProductRoute extends _i30.PageRouteInfo<void> {
...
class ListRepairerRoute extends _i30.PageRouteInfo<void> {
...
class RepairerProfileRoute
    extends _i30.PageRouteInfo<RepairerProfileRouteArgs> {
  RepairerProfileRoute({required String providerID, _i31.Key? key})
...
class OverViewOrderRoute extends _i30.PageRouteInfo<OverViewOrderRouteArgs> {
  OverViewOrderRoute({_i31.Key? key, required String providerID})
...
class FAQsItemOTPRoute extends _i30.PageRouteInfo<void> {
...
/// generated route for
/// [_i26.HomeBodyPage]
class HomeBodyRoute extends _i30.PageRouteInfo<void> {
...
/// generated route for
/// [_i27.ActivatePage]
class ActivateRoute extends _i30.PageRouteInfo<void> {

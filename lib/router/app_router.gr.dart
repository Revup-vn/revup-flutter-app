...
import 'package:revup/account/view/account_page.u.dart' as _i42;
import 'package:revup/activate/history/view/view.dart' as _i40;
...
import 'package:revup/h22_invoice/models/service_data.dart' as _i47;
...
import 'package:revup/h26_review-repairman/view/review_repairman_page.u.dart'
    as _i6;
import 'package:revup/h2_find_provider/models/provider_data.u.dart' as _i46;
...
import 'package:revup/h6_request_provider/view/request_provider_page.dart'
    as _i24;
import 'package:revup/history_consumer/model/history_model.dart' as _i48;
...
import 'package:revup/home/widgets/home_body_page.u.dart' as _i39;
...
import 'package:revup/notification_page/view/notification_page.u.dart' as _i41;
...
import 'package:revup/repairer_profile/models/service_data.u.dart' as _i50;
...
import 'package:revup_core/core.dart' as _i45;
...
class AppRouter extends _i43.RootStackRouter {
  ...
  final Map<String, _i43.PageFactory> pagesMap = {
    ...
    NewServiceRequestRoute.name: (routeData) {
      ...
      return _i43.AdaptivePage<List<_i45.OptionalService>>(
          routeData: routeData,
    ...
    HomeBodyRoute.name: (routeData) {
      ...
      return _i43.AdaptivePage<void>(
          routeData: routeData,
          child: _i39.HomeBodyPage(key: args.key, user: args.user));
    },
    HistoryProviderRoute.name: (routeData) {
      final args = routeData.argsAs<HistoryProviderRouteArgs>();
      return _i43.AdaptivePage<void>(
          routeData: routeData,
          child: _i40.HistoryProviderPage(args.cid, key: args.key),
          maintainState: false);
    },
    NotificationRoute.name: (routeData) {
      return _i43.AdaptivePage<void>(
          routeData: routeData, child: const _i41.NotificationPage());
    },
    AccountRoute.name: (routeData) {
      return _i43.AdaptivePage<void>(
          routeData: routeData, child: const _i42.AccountPage());
    }
  };

  @override
  List<_i43.RouteConfig> get routes => [
        _i43.RouteConfig(SplashRoute.name, path: '/'),
        _i43.RouteConfig(OrderDetailRoute.name, path: '/order-detail-page'),
        _i43.RouteConfig(RepairStatusRoute.name, path: '/repair-status-page'),
        _i43.RouteConfig(ServiceInvoiceRoute.name,
            path: '/service-invoice-page'),
        _i43.RouteConfig(InvoicePaymentRoute.name,
            path: '/invoice-payment-page'),
        _i43.RouteConfig(ReviewRepairmanRoute.name,
            path: '/review-repairman-page'),
        _i43.RouteConfig(ChangeLanguageRoute.name,
            path: '/change-language-page'),
        _i43.RouteConfig(ReportRoute.name, path: '/report-page'),
        _i43.RouteConfig(TestRoute.name, path: '/test-page'),
        _i43.RouteConfig(HomeRoute.name, path: '/home-page', children: [
          _i43.RouteConfig(HomeBodyRoute.name,
              path: 'home-body-page', parent: HomeRoute.name),
          _i43.RouteConfig(HistoryProviderRoute.name,
        ...
        _i43.RouteConfig(HistoryDetailRoute.name, path: '/history-detail-page'),
        _i43.RouteConfig(HistoryProviderDetailRoute.name,
            path: '/history-provider-detail-page'),
        _i43.RouteConfig(PaymentRoute.name, path: '/payment-page'),
        _i43.RouteConfig(UpdateProfileRoute.name, path: '/update-profile-page'),
        _i43.RouteConfig(LoginRoute.name, path: '/login-page'),
        _i43.RouteConfig(OnboardingRoute.name, path: '/onboarding-page'),
        _i43.RouteConfig(OTPRoute.name, path: '/o-tp-page'),
        _i43.RouteConfig(SignupRoute.name, path: '/signup-page'),
        _i43.RouteConfig(ChooseServiceRoute.name, path: '/choose-service-page'),
        _i43.RouteConfig(NewServiceRequestRoute.name,
            path: '/new-service-request-page'),
        _i43.RouteConfig(ServiceDetailRoute.name, path: '/service-detail-page'),
        _i43.RouteConfig(ChooseProductRoute.name, path: '/choose-product-page'),
        _i43.RouteConfig(FindNearbyRoute.name, path: '/find-nearby-page'),
        _i43.RouteConfig(RequestProviderRoute.name,
            path: '/request-provider-page'),
        _i43.RouteConfig(RepairerProfileRoute.name,
            path: '/repairer-profile-page'),
        _i43.RouteConfig(AddMessageRoute.name, path: '/add-message-page'),
        _i43.RouteConfig(OverViewOrderRoute.name,
            path: '/over-view-order-page'),
        _i43.RouteConfig(FAQsRoute.name, path: '/f-aqs-page'),
        _i43.RouteConfig(FAQsItemOTPRoute.name, path: '/f-aqs-item-ot-pPage'),
        _i43.RouteConfig(AboutUsRoute.name, path: '/about-us-page'),
        _i43.RouteConfig(TermsPrivacyRoute.name, path: '/terms-privacy-page'),
        _i43.RouteConfig(LoginEnterPhoneRoute.name,
            path: '/login-enter-phone-page'),
        _i43.RouteConfig(PermissionRoute.name, path: '/permission-page'),
        _i43.RouteConfig(MapRouteRoute.name, path: '/map-route-page'),
        _i43.RouteConfig(AddReportRoute.name, path: '/add-report-page'),
        _i43.RouteConfig(FindProviderRoute.name, path: '/find-provider-page'),
        _i43.RouteConfig(CountdownRoute.name, path: '/countdown-page'),
        _i43.RouteConfig(ConfirmServiceRoute.name,
...
/// generated route for
/// [_i2.OrderDetailPage]
class OrderDetailRoute extends _i43.PageRouteInfo<OrderDetailRouteArgs> {
  OrderDetailRoute({_i44.Key? key})
...
class RepairStatusRoute extends _i43.PageRouteInfo<RepairStatusRouteArgs> {
  RepairStatusRoute({required String recordId, _i44.Key? key})
...
class ServiceInvoiceRoute extends _i43.PageRouteInfo<ServiceInvoiceRouteArgs> {
  ServiceInvoiceRoute(
      {required String providerID, required String id, _i44.Key? key})
...
class InvoicePaymentRoute extends _i43.PageRouteInfo<InvoicePaymentRouteArgs> {
  InvoicePaymentRoute(
      {required _i46.ProviderData providerData,
      required List<_i47.ServiceData> serviceData,
      _i44.Key? key})
...
class InvoicePaymentRouteArgs {
  ...
  final List<_i47.ServiceData> serviceData;
...
class ReviewRepairmanRoute
    extends _i43.PageRouteInfo<ReviewRepairmanRouteArgs> {
  ReviewRepairmanRoute(
      {required String providerId, required String repairId, _i44.Key? key})
...
class ChangeLanguageRoute extends _i43.PageRouteInfo<void> {
...
/// generated route for
/// [_i8.ReportPage]
class ReportRoute extends _i43.PageRouteInfo<ReportRouteArgs> {
  ReportRoute({required String cid, _i44.Key? key})
...
/// generated route for
/// [_i9.TestPage]
class TestRoute extends _i43.PageRouteInfo<void> {
...
class HistoryDetailRoute extends _i43.PageRouteInfo<HistoryDetailRouteArgs> {
  HistoryDetailRoute({_i44.Key? key, required _i48.HistoryModel historyModel})
...
class HistoryDetailRouteArgs {
  ...
  final _i48.HistoryModel historyModel;
...
class HistoryProviderDetailRoute
    extends _i43.PageRouteInfo<HistoryProviderDetailRouteArgs> {
  HistoryProviderDetailRoute({required String rpID, _i44.Key? key})
...
/// generated route for
/// [_i13.PaymentPage]
class PaymentRoute extends _i43.PageRouteInfo<PaymentRouteArgs> {
  PaymentRoute(
      {_i44.Key? key,
      required _i45.AppUser user,
      _i49.Completer<dynamic>? completer})
...
class PaymentRouteArgs {
  ...
  final _i49.Completer<dynamic>? completer;
...
class UpdateProfileRoute extends _i43.PageRouteInfo<UpdateProfileRouteArgs> {
  UpdateProfileRoute({_i44.Key? key, required _i45.AppUser user})
...
/// generated route for
/// [_i17.OTPPage]
class OTPRoute extends _i43.PageRouteInfo<OTPRouteArgs> {
  OTPRoute(
      {required String phoneNumber,
      required _i49.Completer<String> completer,
      _i44.Key? key})
      : super(OTPRoute.name,
            path: '/o-tp-page',
            args: OTPRouteArgs(
...
class OTPRouteArgs {
  ...
  final _i49.Completer<String> completer;
...
class SignupRoute extends _i43.PageRouteInfo<SignupRouteArgs> {
  SignupRoute(
      {required _i49.Completer<_i45.AppUser> completer,
      required String phoneNumber,
...
class SignupRouteArgs {
  ...
  final _i49.Completer<_i45.AppUser> completer;
...
class ChooseServiceRoute extends _i43.PageRouteInfo<ChooseServiceRouteArgs> {
  ChooseServiceRoute(
      {_i44.Key? key,
      required String providerId,
      String? recordId,
      required List<_i45.OptionalService> optionalService})
...
class ChooseServiceRouteArgs {
  ...
  final List<_i45.OptionalService> optionalService;
...
class NewServiceRequestRoute
    extends _i43.PageRouteInfo<NewServiceRequestRouteArgs> {
...
class ServiceDetailRoute extends _i43.PageRouteInfo<ServiceDetailRouteArgs> {
  ServiceDetailRoute(
      {_i44.Key? key,
      required String providerId,
      required _i50.ServiceData serviceData})
      : super(ServiceDetailRoute.name,
            path: '/service-detail-page',
            args: ServiceDetailRouteArgs(
                key: key, providerId: providerId, serviceData: serviceData));
...
class ServiceDetailRouteArgs {
  const ServiceDetailRouteArgs(
      {this.key, required this.providerId, required this.serviceData});

  final _i44.Key? key;

  final String providerId;

  final _i50.ServiceData serviceData;
...
class ChooseProductRoute extends _i43.PageRouteInfo<ChooseProductRouteArgs> {
  ChooseProductRoute(
      {_i44.Key? key,
      required _i50.ServiceData serviceData,
      required String providerId,
...
/// generated route for
/// [_i23.FindNearbyPage]
class FindNearbyRoute extends _i43.PageRouteInfo<FindNearbyRouteArgs> {
  FindNearbyRoute({_i44.Key? key, required _i51.LatLng currentLocation})
...
class RequestProviderRoute
    extends _i43.PageRouteInfo<RequestProviderRouteArgs> {
...
class RepairerProfileRoute
    extends _i43.PageRouteInfo<RepairerProfileRouteArgs> {
  RepairerProfileRoute({_i44.Key? key, required _i46.ProviderData providerData})
...
/// generated route for
/// [_i26.AddMessagePage]
class AddMessageRoute extends _i43.PageRouteInfo<AddMessageRouteArgs> {
  AddMessageRoute(
      {_i44.Key? key,
      required _i46.ProviderData providerData,
...
class OverViewOrderRoute extends _i43.PageRouteInfo<OverViewOrderRouteArgs> {
  OverViewOrderRoute(
      {_i44.Key? key, required String providerId, required String recordId})
...
/// generated route for
/// [_i28.FAQsPage]
class FAQsRoute extends _i43.PageRouteInfo<void> {
...
class FAQsItemOTPRoute extends _i43.PageRouteInfo<void> {
...
class TermsPrivacyRoute extends _i43.PageRouteInfo<void> {
...
class LoginEnterPhoneRoute
    extends _i43.PageRouteInfo<LoginEnterPhoneRouteArgs> {
  LoginEnterPhoneRoute(
      {required _i49.Completer<dynamic> completer,
      required String phoneNumber,
      required String photoURL,
      required String uid,
      required String email,
...
/// generated route for
/// [_i33.PermissionPage]
class PermissionRoute extends _i43.PageRouteInfo<void> {
...
/// generated route for
/// [_i34.MapRoutePage]
class MapRouteRoute extends _i43.PageRouteInfo<MapRouteRouteArgs> {
  MapRouteRoute({_i44.Key? key, required String providerId})
...
/// generated route for
/// [_i35.AddReportPage]
class AddReportRoute extends _i43.PageRouteInfo<AddReportRouteArgs> {
  AddReportRoute({required String reportID, _i44.Key? key})
...
class FindProviderRoute extends _i43.PageRouteInfo<void> {
...
/// generated route for
/// [_i37.CountdownPage]
class CountdownRoute extends _i43.PageRouteInfo<CountdownRouteArgs> {
  CountdownRoute({_i44.Key? key, required String token})
...
/// generated route for
/// [_i38.ConfirmServicePage]
class ConfirmServiceRoute extends _i43.PageRouteInfo<ConfirmServiceRouteArgs> {
  ConfirmServiceRoute(
      {_i44.Key? key,
      required String providerId,
      required String recordId,
      required List<_i45.OptionalService> optionalService})
      : super(ConfirmServiceRoute.name,
            path: '/confirm-service-page',
...
/// generated route for
/// [_i39.HomeBodyPage]
class HomeBodyRoute extends _i43.PageRouteInfo<HomeBodyRouteArgs> {
  HomeBodyRoute({_i44.Key? key, required _i45.AppUser user})
...
/// generated route for
/// [_i40.HistoryProviderPage]
class HistoryProviderRoute
    extends _i43.PageRouteInfo<HistoryProviderRouteArgs> {
  HistoryProviderRoute({required String cid, _i44.Key? key})
